...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_RCM_HWINFO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_SIM_UUID_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUX_DATA_QUICK_ACCESS_SRAM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUX_CODE_QUICK_ACCESS_RAMFUNC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUX_NONCACHEABLE_CUSTOM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_KL2X, 1);
